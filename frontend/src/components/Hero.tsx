    ...
    return (
        <section
            className="
                ...
                w-full 
                bg-cover bg-center bg-no-repeat bg-[url('https://tailframes.com/images/squares-bg.webp')]"
        >
            <div
                className="
                    m-auto flex max-w-screen-xl grow 
                    flex-col items-center justify-start 
                    gap-6 pt-12 md:gap-12 
                    py-20 
                    px-3 sm:px-8 lg:px-16 xl:px-32"
            >
                <div className="flex flex-1 flex-col items-center gap-6 text-center">
                    <Badge size="large" variant="secondary">
                        Pre-registrate pronto.
                    </Badge>
                    <div className="flex max-w-lg flex-col gap-6">
                        ...
                        <p className="text-3xl font-normal leading-7 text-slate-500">
                            Cambia tu armario todos los días de forma 
                            <span className="
